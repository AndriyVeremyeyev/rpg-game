...
import {setBattleVisible, setInventoryVisible, setSword} from './actions';
...
const Inventory = ({setBattleVisible, setInventoryVisible, inventory, setSword}) => {
  ...
  return (
    <Grid container direction='column' justify="center" alignItems='center'>
      <Grid container direction="row" justify="center" spacing={2}>
        {imageCover(Image1, 'Sword', inventory[0], clickOnSword)}
